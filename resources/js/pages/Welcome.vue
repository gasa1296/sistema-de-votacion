...
<template>
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-5 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20"
                >
                ...
                <div
                    class="relative -mb-px aspect-335/364 w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-109.5 lg:rounded-t-none lg:rounded-r-lg"
                >
                    <!-- Laravel Logo -->
                    <svg
                    ...
                    <!-- 13 -->
                    <svg
                        class="relative mt-[-6.6rem] -ml-8 w-109.5 max-w-none [--stroke-color:#1B1B18] lg:ml-0"
                        viewBox="0 0 440 392"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        ...
                        <g
                            class="text-[#F3BEC7] opacity-100 transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-6.5"
                        >
                            <mask
                                id="path-2-mask"
                                maskUnits="userSpaceOnUse"
                        ...
                        <g
                            class="text-[#F8B803] opacity-100 mix-blend-color transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-12.75"
                        >
                            <mask
                                id="path-3-mask"
                                maskUnits="userSpaceOnUse"
                        ...
                        <g
                            class="text-[#F3BEC7] opacity-100 mix-blend-multiply transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-19.5"
                        >
                            <mask
                                id="path-4-mask"
                                maskUnits="userSpaceOnUse"
                        ...
                        <g
                            class="text-[#F3BEC7] opacity-100 mix-blend-hard-light transition-all delay-400 duration-750 starting:opacity-0 motion-safe:starting:-translate-x-25.5"
                        >
                            <mask
                                id="path-5-mask"
                                maskUnits="userSpaceOnUse"
