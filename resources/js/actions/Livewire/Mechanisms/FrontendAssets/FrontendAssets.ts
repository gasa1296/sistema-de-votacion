...
* @route '/livewire-ed3dddb5/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-ed3dddb5/livewire.js',
...
* @route '/livewire-ed3dddb5/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-ed3dddb5/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-ed3dddb5/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-ed3dddb5/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
