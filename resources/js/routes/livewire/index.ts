...
* @route '/livewire-ed3dddb5/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-ed3dddb5/upload-file',
...
* @route '/livewire-ed3dddb5/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-ed3dddb5/preview-file/{filename}',
