...
* @route '/livewire-5cf12cc7/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-5cf12cc7/upload-file',
...
* @route '/livewire-5cf12cc7/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-5cf12cc7/preview-file/{filename}',
