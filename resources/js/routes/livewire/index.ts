 ...
 * @route '/livewire-afa7d0b0/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-afa7d0b0/upload-file',
 ...
 * @route '/livewire-afa7d0b0/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-afa7d0b0/preview-file/{filename}',
